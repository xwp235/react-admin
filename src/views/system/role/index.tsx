...
import { RoleItem, Params } from '@/types/Role'
...
import CreateRole from '@/views/system/role/CreateRole'
...
export default function RoleManage() {
  ...
  const getTableData = ({ current, pageSize }: { current: number; pageSize: number }, formData: Params) => {
